...
db_name = "postgres"  #nom de la BDD
db_password = "rima1999" #PSW de compte
...
app.config['MAIL_USERNAME'] = 'srcscholar801@gmail.com' #mail utilisé 
app.config['MAIL_PASSWORD'] = 'srcsholar123'  #PSW utilisé 
